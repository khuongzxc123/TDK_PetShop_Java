<%-- 
    Document   : Orders
    Created on : Mar 21, 2023, 3:37:41 PM
    Author     : Admin
--%>
...
<%
    ...
    if (account != null) {
        ...
        orders = new DAO().userOrders(Integer.parseInt(account.getUserId()));
    } else {
                    ...
                    <table class="table table-borderless">
                        ...
                        <%
                            if (orders != null) {
                                for (Order o : orders) {%>
                        <tr>
                            <td style="text-align: center"><%= o.getDate()%></td>
                            <td style="text-align: center"><%= o.getProName()%></td>
                            <td style="text-align: center"><%= o.getProCategory()%></td>
                            <td style="text-align: center"><%= o.getQuantity()%></td>
                            <td style="text-align: center"><%= dcf.format(o.getProPrice())%></td>
                            <td style="text-align: center"><a class="btn btn-danger btn-sm" href="cancelorder?id=<%= o.getOrderId()%>"> Cancel </a></td>
                        </tr>
                        <%}
                            }
                        %> 
